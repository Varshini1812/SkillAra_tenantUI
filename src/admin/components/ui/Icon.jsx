/**
 * Single icon set for the admin console.
 *
 * 24x24 grid, stroke-width 2, `currentColor` — one visual language everywhere
 * (`icon-style-consistent`). Emoji are never used as icons.
 *
 * Accessibility (`icon-context`):
 *   - Decorative, sitting beside visible text -> omit `label`, renders aria-hidden.
 *   - Meaningful or inside an icon-only control -> pass `label`, renders role="img".
 */
...
const PATHS = {
  ...
  moderation: (
    <>
      <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 8 2a6 6 0 0 0 2.6-.6A1 1 0 0 1 20 4v9a1 1 0 0 1-.4.8A6 6 0 0 1 16 15c-3 0-5-2-8-2a6 6 0 0 0-4 1" />
    </>
  ),
  ...
  mentor: (
    <>
      ...
      <path d="M17 4.5 18.4 7l2.6.4-1.9 1.8.5 2.6L17 10.6 14.4 11.8l.5-2.6L13 7.4 15.6 7Z" />
    </>
  ),
  database: (
    <>
  ...
  sort: <path d="m8 3 4 4H4l4-4Zm8 18-4-4h8l-4 4Z" />,
  sortAsc: <path d="M12 5v14M6 11l6-6 6 6" />,
  sortDesc: <path d="M12 19V5M6 13l6 6 6-6" />,
  ...
  books: (
    <>
      ...
      <path d="m16.5 5 3.5 14.5-2 .5L14.5 5.5Z" />
    </>
  ),
  graduation: (
    <>
      <path d="M22 9 12 5 2 9l10 4Z" />
  ...
  paperclip: (
    <path d="M21 12.5 12.9 20.6a5 5 0 0 1-7.1-7.1l8.5-8.5a3.5 3.5 0 0 1 5 5l-8.5 8.5a2 2 0 0 1-2.8-2.8l7.8-7.8" />
  ),
  arrowLeft: (
    <>
      <path d="M19 12H5" />
...
export default function Icon({ name, size = 20, className = "", label, strokeWidth = 2 }) {
