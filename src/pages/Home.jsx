...
export default function Home() {
  ...
  return (
    <div>
      <section className="rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-700 px-8 py-16 text-white">
        ...
        <div className="mt-8 flex gap-4">
          <Link
            to="/courses"
            className="rounded-lg bg-white px-5 py-2.5 font-medium text-indigo-700 hover:bg-indigo-50"
          >
            Browse Courses
          </Link>
          <Link
